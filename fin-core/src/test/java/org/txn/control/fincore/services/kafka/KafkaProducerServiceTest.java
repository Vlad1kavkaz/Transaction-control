...
class KafkaProducerServiceTest {
    ...
    void testSendResponse_Success() {
        ...
        // Act
        kafkaProducerService.sendResponse(topic, key, payload);
    ...
    void testSendResponse_WithNullPayload() {
        ...
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> kafkaProducerService.sendResponse(topic, key, null));
    }
    ...
    void testSendResponse_EmptyKey() {
        ...
        // Act
        kafkaProducerService.sendResponse(topic, key, transaction);
    ...
    void testSendResponse_NullTopic() {
        ...
        // Act
        kafkaProducerService.sendResponse(topic, key, category);
